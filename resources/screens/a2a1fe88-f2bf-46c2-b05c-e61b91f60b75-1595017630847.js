jQuery("#simulation")
  .on("click", ".s-a2a1fe88-f2bf-46c2-b05c-e61b91f60b75 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/49e625ec-e44e-42de-8235-6d28b0d97ca4",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Complaint_6","#s-Complaint_5" ],
                    "effect": {
                      "type": "slide",
                      "easing": "easeOutQuad",
                      "duration": 500,
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-a2a1fe88-f2bf-46c2-b05c-e61b91f60b75 #s-Label_83 span": {
                      "attributes": {
                        "color": "#80B8F1"
                      }
                    }
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a2a1fe88-f2bf-46c2-b05c-e61b91f60b75 #s-Image_7 > svg": {
                      "attributes": {
                        "overlay": "#80B8F1"
                      }
                    }
  ...
  .on("swipeleft", ".s-a2a1fe88-f2bf-46c2-b05c-e61b91f60b75 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-a2a1fe88-f2bf-46c2-b05c-e61b91f60b75 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
